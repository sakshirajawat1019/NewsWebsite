...
$result = mysqli_query($conn,$sql) or die("Query failed.12");
...
$result1 = mysqli_query($conn,$sql1) or die("Query failed.13");
...
if (mysqli_num_rows($result1) > 0) {
    ...
    if ($page > 1) {
    echo '<li><a <a href="post.php?fage='. ($page - 1).'">Prev</a></li>';
  }
    for($i = 1;$i <= $total_page; $i++){
     ...
     echo '<li class="'.$active.'"><a href="post.php?fage='. $i.'">'. $i.'</a></li>';
    }
    if ($total_page > $page) {
      echo '<li><a href="post.php?fage='. ($page + 1).'">Next</a></li>';
    }
