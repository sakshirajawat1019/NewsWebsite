            ...
            <div class="col-md-8">
                ...
                ?>
                  ...
                  if(mysqli_num_rows($result1) > 0){
                    ...
                    if($fage > 1){
                      echo '<li><a href="index.php?search='.$search_term .'&fage='.($fage - 1).'">Prev</a></li>';
                    }
                    for($i = 1; $i <= $total_page; $i++){
                      ...
                      echo '<li class="'.$active.'"><a href="index.php?search='.$search_term .'&fage='.$i.'">'.$i.'</a></li>';
                    }
                    if($total_page > $fage){
                      echo '<li><a href="index.php?search='.$search_term .'&fage='.($fage + 1).'">Next</a></li>';
                    }
