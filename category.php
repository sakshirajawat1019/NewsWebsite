        ...
        <div class="row">
            <div class="col-md-8">
              ...
              if (mysqli_num_rows($result1) > 0) {
                  ...
                  if ($page > 1) {
                  echo '<li><a href="index.php?cid='.$cat_id.'&fage='. ($page - 1).'">Prev</a></li>';
                }
                  for($i = 1;$i <= $total_page; $i++){
                   ...
                   echo '<li class="'.$active.'"><a href="index.php?cid='.$cat_id.'&fage='. $i.'">'. $i.'</a></li>';
                  }
                  if ($total_page > $page) {
                    echo '<li><a href="index.php?cid='.$cat_id.'&fage='. ($page + 1).'">Next</a></li>';
                  }
